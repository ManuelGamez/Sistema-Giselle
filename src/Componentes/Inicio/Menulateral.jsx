...
import manos from '../../img/Hand-Sign-05-256.png';
import cabello from '../../img/Beautician-256.png';
import cortes from '../../img/cortes.png';
function Menulateral(props) {
  return (
        <>
         <div class="btn-group-vertical  marginbarramenu">
            <button type="button" class="btn btn-light textoizquierda btn-sm">
            ...
            <button type="button" class="btn btn-light textoizquierda btn-sm">
              <img src={manos} className="icono"/> MANOS
            </button>
            <button type="button" class="btn btn-light textoizquierda btn-sm">
              <img src={cabello} className="icono"/> CABELLO
            </button>
            <button type="button" class="btn btn-light textoizquierda btn-sm">
            <img src={cortes} className="icono"/> CORTES
            </button>
            <button type="button" class="btn btn-light textoizquierda btn-sm">
